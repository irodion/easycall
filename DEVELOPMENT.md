...
Technical documentation for developing and contributing to EasyCall.
...
- [CLAUDE.md](CLAUDE.md) — AI assistant instructions and detailed architecture notes
- [docs/PRD_EasyCall.md](docs/PRD_EasyCall.md) — Full product requirements document
- [docs/CHANGELOG.md](docs/CHANGELOG.md) — Release history
- [docs/accessibility-audit.md](docs/accessibility-audit.md) — Accessibility audit results
- [docs/references/e2e-emulator-testing.md](docs/references/e2e-emulator-testing.md) — E2E testing with Firebase Emulators
